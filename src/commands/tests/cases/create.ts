...
import type { ResponseEngine, TestCaseDefinitionCreateInput, TestCaseDefinitionMutationOutput } from '../../../types/tests';
 ...
 */
function buildResponseEngine(options: CreateTestCaseOptions): ResponseEngine | null {
 ...
 */
export async function createTestCaseCommand(options: CreateTestCaseOptions): Promise<void> {
  try {
